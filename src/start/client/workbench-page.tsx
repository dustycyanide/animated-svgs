        ...
        <section class="preview-column" aria-label="Preview and output library">
          ...
          <section class="panel viewer-card">
            ...
            <div class="discord-export">
              ...
              <label class="inline-control discord-export-config-control" for="discord-export-config-preset">
                <span>Preset</span>
                <select id="discord-export-config-preset" class="select-input"></select>
              </label>
